  ...
  render() {
    return (
      <div className="createProduct">
        ...
        <h1>sell plant</h1>
        <img style={{marginTop: "-3%", marginLeft:"65%", objectFit: "cover", objectPosition: "0% 0%"}} width="370" height="370" src="https://hips.hearstapps.com/hmg-prod/images/pretty-pink-plants-1554757430.jpg?crop=1.00xw:1.00xh;0,0&resize=1200:*" alt="cpmain"/>
        <Segment>         
