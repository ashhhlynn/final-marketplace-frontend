        ...
        return (
            ...
            <Table compact basic='very'>
                <Table.Body>    
                    ...
                    <Table.Row>
                        <Table.Cell  style={{ fontSize:"18px", marginTop: "3%"}}><br></br>Total</Table.Cell>
                        <Table.Cell style={{ fontSize:"18px"}} textAlign="right"><br></br>${((this.props.total * 1.1 + 10)).toFixed(2)}</Table.Cell>
                    </Table.Row>
                </Table.Body>   
            </Table>             
            </div>
