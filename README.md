...
- Users can create accounts and sign in, authenticated and authorized through BCrypt and JWT.
...
- clone the backend repo:  https://github.com/ashhhlynn/final-marketplace-api 
- cd into the repo
- run bundle install 
